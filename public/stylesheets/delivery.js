function initialize() {
  ...
  mapOptions = {
    zoom: 15,
    center: new google.maps.LatLng(38.349819, -81.632623), 
  ...
  function calculateDistance(lat, long) {
    ...
    var destination = new google.maps.LatLng(38.349819, -81.632623); 
    var request = {
      origin: origin,
    ...
    directionsService.route(request, function (result, status) {
      if (status === google.maps.DirectionsStatus.OK) {
        ...
        if (formattedDistance < 10) { 
          document.querySelector(".distance").innerHTML = `Status: <i class="fa fa-check" aria-hidden="true" style="color: green"></i>
          ...
          document.querySelector(".distance").innerHTML = `Status: <i class="fa fa-times" aria-hidden="true" style="color: red"></i>
